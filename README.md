...
## libhri (noetic) - 0.6.1-2

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Wed, 05 Jul 2023 11:09:00 -0000`
...
## libhri (melodic) - 0.6.1-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Wed, 12 Apr 2023 13:31:37 -0000`
...
## libhri (noetic) - 0.6.1-1

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Wed, 12 Apr 2023 13:27:56 -0000`
...
## libhri (melodic) - 0.6.0-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Thu, 05 Jan 2023 08:01:20 -0000`
...
## libhri (noetic) - 0.6.0-1

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Thu, 05 Jan 2023 07:58:45 -0000`
...
## libhri (noetic) - 0.5.3-1

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Tue, 25 Oct 2022 22:05:05 -0000`
...
## libhri (melodic) - 0.5.3-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Tue, 25 Oct 2022 21:22:07 -0000`
...
## libhri (melodic) - 0.5.1-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Thu, 06 Oct 2022 08:29:31 -0000`
...
## libhri (noetic) - 0.5.1-1

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Thu, 06 Oct 2022 08:26:25 -0000`
...
## libhri (noetic) - 0.5.0-1

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Thu, 26 May 2022 16:19:47 -0000`
...
## libhri (melodic) - 0.5.0-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Thu, 26 May 2022 16:18:16 -0000`
...
## libhri (melodic) - 0.4.3-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Thu, 28 Apr 2022 12:14:15 -0000`
...
## libhri (noetic) - 0.4.3-1

The packages in the `libhri` repository were released into the `noetic` distro by running `/usr/bin/bloom-release libhri -r noetic` on `Thu, 28 Apr 2022 12:12:27 -0000`
...
## libhri (melodic) - 0.4.2-1

The packages in the `libhri` repository were released into the `melodic` distro by running `/usr/bin/bloom-release libhri -r melodic` on `Wed, 27 Apr 2022 15:02:34 -0000`
